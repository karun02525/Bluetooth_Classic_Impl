...
import com.bluetooth_demo.utils.PermissionUtils.REQ_CODE
import com.bluetooth_demo.utils.PermissionUtils.permissions
...
class BluetoothHelper(private val context: Context, private val listener: BluetoothHelperListener) {
    ...
    private fun checkBTPermissions() {
                (context as Activity).requestPermissions(permissions.toTypedArray(), REQ_CODE)
